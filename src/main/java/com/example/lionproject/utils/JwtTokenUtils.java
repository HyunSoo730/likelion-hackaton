package com.example.lionproject.utils;
...
public class JwtTokenUtils {
    ...
    public static String generateToken(KakaoMember user, String secretKLey, Long expireTime) {
     ...
     * 토큰 유효 여부 확인
     */
    public Boolean isValidToken(String token, KakaoMember user, String key) {
