...
@NoArgsConstructor
@AllArgsConstructor
public class PublicReservationEducationDto {
    ...
    public static PublicReservationEducationDto of(String gubun, String svcId, String maxClassNM, String minClassNM, String svcStatNM, String svnNM,
                                                   String payatNM, String placeNM, String useTgtInfo, String svcUrl, String x, String y, String svccopnbgndt,
                                                   String svcopnenddt, String rcptbgndt, String rcptenddt, String areaNM, String imgUrl, String dtlcont,
                                                   String telno, String vMin, String vMax, String revStdDayNM, String revStdDay) {
        return new PublicReservationEducationDto(
                gubun,
                svcId,
                maxClassNM,
                minClassNM,
