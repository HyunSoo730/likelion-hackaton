...
<div align="center">
<img width="550" alt="다오 이미지" src="https://github.com/HyunSoo730/likelion-hackaton/assets/102610889/71dcaa3d-b255-4f9d-b6e3-588662da0afd">
</div>
...
| 김민섭 | - 🤝 조현수 리드와 함께 백엔드 서버 개발 담당<br>- 🌿 디자인 패턴을 적용한 API 컨트롤러 개발 및 예외 처리<br>- 🗃️ MyBatis를 활용한 데이터 액세스 로직 개발 및 쿼리 작성<br>- 📊 사용자 행동 데이터 수집 및 분석을 위한 로그 설계 및 로깅 작업<br>- 🧪 단위 테스트 코드 작성을 통한 코드 품질 개선 활동|
...
고령화 사회로 접어들면서 노인 일자리에 대한 수요가 증가하고 있지만, 고령층의 디지털 정보 접근성 부족으로 인해 많은 어르신들이 재취업의 기회를 놓치고 있습니다. 이를 해결하고자 거주 지역을 기반으로 일자리 정보를 추천하고, 새로운 일자리가 등록되면 카카오톡 알림을 통해 바로 확인할 수 있는 맞춤형 서비스 '다오'를 기획하였습니다. 

다오는 어르신들의 디지털 격차를 해소하고 재취업 기회를 확대하는 것을 목표로 합니다. 사용자 친화적인 인터페이스와 직관적인 기능을 통해 어르신들도 쉽게 일자리 정보를 확인하고 지원할 수 있도록 도와줍니다. 또한 카카오톡 알림 기능으로 새로운 일자리가 등록되면 실시간으로 사용자에게 알려줌으로써 적극적인 구직 활동을 지원합니다.

다오는 단순히 일자리 정보를 제공하는 것에서 나아가, 어르신들의 경력과 관심사를 고려한 맞춤형 일자리 추천 알고리즘을 탑재하고 있습니다. 이를 통해 어르신들은 자신에게 적합한 일자리를 더욱 빠르고 효과적으로 찾을 수 있게 됩니다.
...
프로젝트의 데이터베이스 설계는 위와 같은 ERD를 바탕으로 이루어졌습니다. 주요 테이블과 그 관계는 다음과 같습니다:
...
데이터베이스 설계는 프로젝트의 요구사항과 확장성을 고려하여 진행되었으며, 필요에 따라 추가적인 테이블이나 관계를 도입할 수 있는 유연성을 가지고 있습니다.
...
| 구직 정보 신청 페이지에서는 원하는 일자리에 간편하게 지원할 수 있습니다. 사용자 정보를 입력하고 지원 동기를 작성하여 기업에 어필할 수 있습니다. | 구직 정보 신청 시 해당 일자리의 주요 정보를 한 번 더 확인할 수 있는 팝업 창이 제공됩니다. 이를 통해 사용자는 자신의 선택을 되돌아보고 신중하게 지원할 수 있습니다. |
...
### ⭐️ 실시간 일자리 알림
사용자가 설정한 관심 지역에 새로운 일자리가 등록되면 카카오톡으로 실시간 알림을 보내줍니다.
